"""Client-specific dialog classes.

This module contains dialog classes used primarily by the BigTime client
...
__all__ = [
    'EditLogsDialog',
    'EditTimeSelectorDialog',
    'AddEmployeeDialog',
    'EditEmployeeDialog',
    'EmployeeListDialog',
    'ConfigDialog',
    'OOTBClientDialog',
    'ClientSyncSettingsDialog',
    'PinDialog'
]
...
def set_dialog_icon(dialog):
    ...
    Args:
        dialog: The dialog widget to set the icon on
    """
...
class ClientSyncSettingsDialog(QDialog):
